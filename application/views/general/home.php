  ...
  <div id="wrapper">
    ...
    <div id="intro">
      <div class="intro-content">
        <h2>together we begin !</h2>
        <h3>let's rebuild Kerala :)</h3>
        <div class="row">
            <!--<div class="span3"></div>-->
          <div class="span3">
            <a href="offer_service" class="btn-get-started scrollto">Offer Service</a>
          </div>
<!--          <div class="hidden span4">
            <a href="request_service" class="btn-get-started scrollto">Request Service</a>
          </div>-->
          <div class="span3">
            <a href="nearby" class="btn-get-started scrollto">Nearby Services</a>
          </div>
        </div>
      </div>
    </div>
